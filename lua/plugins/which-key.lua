...
return {
    {
        ...
        wk.setup(opts)
         ...
         wk.add({
             ...
             -- 标签页快速切换 (1-9)
             { "<leader>1", desc = "切换到标签页1 [原生]" },
             { "<leader>2", desc = "切换到标签页2 [原生]" },
             { "<leader>3", desc = "切换到标签页3 [原生]" },
             { "<leader>4", desc = "切换到标签页4 [原生]" },
             { "<leader>5", desc = "切换到标签页5 [原生]" },
             { "<leader>6", desc = "切换到标签页6 [原生]" },
             { "<leader>7", desc = "切换到标签页7 [原生]" },
             { "<leader>8", desc = "切换到标签页8 [原生]" },
             { "<leader>9", desc = "切换到标签页9 [原生]" },
